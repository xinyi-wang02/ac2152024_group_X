...
def download_data(source_bucket_name, csv_blob_name, local_image_dir, local_csv_path):
    ...
    for index, row in df.iterrows():
        ...
        class_name = row['label']  # Assuming 'label' column contains class names
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sb', '--source_bucket_name', default='mini-215-multiclass-car-bucket', help='Source GCS bucket name')
    ...
    parser.add_argument('-db', '--dest_bucket_name', default='mini-tensor-bucket', help='Destination GCS bucket name')
    parser.add_argument('-o', '--output_dir', default='./no_ship', help='Local directory to save temporary files')
    ...
    df = download_data(args.source_bucket_name, args.csv_blob_name, local_image_dir, local_csv_path)
    print("Step 1 done.")
