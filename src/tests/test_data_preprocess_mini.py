...
def test_uploader():
    ...
    data_loader.upload_directory_with_transfer_manager(source_directory=source_directory, bucket_name=TEST_BUCKET_NAME)
...
def test_process_images():
    ...
    process_images(os.path.join(source, "train"), output_dir, output_prefix, image_names)
